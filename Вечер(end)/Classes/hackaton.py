...
bd_password = input("Введите пароль от пользователя Базы Данных: ")
...
# 18. Acer закрыл свою фабрику в Бразилии после 2012 года и переехал в Германию, у всех записей в produsers где Acer 
# был произведен в Brazil после 2012 поставьте Germany.
...
# 21. Найдите товары в sulpak, цена которых больше среднего на 2000 и меньше среднего на 2000
...
# 25. В produsers поменяйте Nokia на Microsoft везде где у компании Nokia указана страна USA.
